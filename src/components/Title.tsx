...
export default function Title() {
    ...
    return (
        <motion.div
            ...
            className="flex flex-col justify-around border-2 border-background-bright md:col-start-1 md:col-end-4 md:row-start-1 md:row-end-4 col-span-1 row-span-1 bg-[#1C2535] rounded-2xl h-64 sm:h-72 md:h-auto p-4 sm:p-6 md:p-8"
        >
            <motion.div
            ...
            >
                <h1>
                    ...
                    {showCursor && (
                        <motion.span
                            className="inline-block w-1 h-8 sm:h-10 md:h-8 bg-white align-middle ml-1"
