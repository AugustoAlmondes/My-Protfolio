...
export const EducationSection = () => {
    return (
        <motion.div
            className="bg-background rounded-2xl p-5 sm:p-6 md:p-8 relative border-2 border-background-bright before:absolute before:content-[''] before:w-full before:h-[50%] before:rounded-2xl before:bg-gradient-to-t before:from-background/60 before:to-transparent before:bottom-0 before:left-0 before:z-10"
            initial={{ y: 30, opacity: 0 }}
            whileInView={{ y: 0, opacity: 1 }}
            viewport={{ once: true }}
            transition={{ duration: 0.6, ease: "easeOut" }}
        >
            <h1 className="text-new-green text-xl sm:text-2xl font-bold mb-4 sm:mb-6">Formação</h1>
            <div className="relative">
                <div className="h-full w-0.5 bg-font-data-color/50 absolute left-3 sm:left-4 -translate-x-1/2" />

                <div className="space-y-4 sm:space-y-6 pl-6 sm:pl-8 max-h-[400px] overflow-y-auto pr-2">
